...
data1 = pd.read_excel(r"C:\Users\32766\Desktop\性别比较-Dummy.xlsx", header=0)
...
my_pal_gender ={"Female": '#e8684a', "Male": '#3C78BA'}
# 创建图形
...
if p_val < 0.05:
    ...
    ax.text(0.85, 0.96, f"p = {p_val:.3f}", ha='center', fontweight='bold', fontsize=14, color='black', transform=ax.transAxes)
